package org.junstory.ex3.product.controller;
...
import org.junstory.ex3.product.service.ProductService;
...
public class ProductController {
    ...
    @PostMapping("")
    public ResponseEntity<ProductDTO> register(@Validated @RequestBody ProductDTO productDTO, Principal principal) {
